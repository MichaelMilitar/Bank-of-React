...
class App extends Component {
  ...
  render() {
    ...
    return (
      <Router>
        <div className = 'App'>
          <Route exact path="/" render={HomeComponent}  className = 'Link'/><br></br>
          <Route exact path="/userProfile" render={UserProfileComponent}  className = 'Link'/><br></br>
          <Route exact path="/login" render={LogInComponent}  className = 'Link'/><br></br>
          <Route exact path="/debits" render={DebitsComponent}  className = 'Link'/><br></br>
          < Route exact path="/credits" render={CreditComponent}  className = 'Link'/><br></br>
        </div>
      </Router>
    );
  }
